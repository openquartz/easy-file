...
//
///**
// * {@link org.svnee.easyfile.common.annotation.FileExportExecutor} Annotation
// * {@link BeanDefinitionRegistryPostProcessor Bean Definition Registry Post Processor}
// *
// * @since 2.5.8
// */
//@Slf4j
//public class FileExportExecutorAnnotationBeanPostProcessor implements BeanDefinitionRegistryPostProcessor,
//    EnvironmentAware,
...
//
//    public FileExportExecutorAnnotationBeanPostProcessor(String... packagesToScan) {
//        this(Arrays.asList(packagesToScan));
//    }
//
//    public FileExportExecutorAnnotationBeanPostProcessor(Collection<String> packagesToScan) {
//        this(new LinkedHashSet<>(packagesToScan));
//    }
//
//    public FileExportExecutorAnnotationBeanPostProcessor(Set<String> packagesToScan) {
...
//
//    /**
//     * Registers Beans whose classes was annotated {@link org.svnee.easyfile.common.annotation.FileExportExecutor}
//     *
...
//
//        scanner.addIncludeFilter(new AnnotationTypeFilter(FileExportExecutor.class));
//
...
//                    log.info("No Spring Bean annotating Dubbo's @Service was found in Spring BeanFactory , " +
//                        "it maybe that some bean was also annotated @Component .");
//                    log.info(
//                        "It will try to find all Bean types annotating Dubbo's @Service from all Bean Definitions");
//                }
//
//                beanDefinitionHolders = findServiceBeanDefinitionHolders(scanner, packageToScan, registry,
//                    beanNameGenerator);
//
//            }
//
...
//
//                if (log.isInfoEnabled()) {
//                    log.info(beanDefinitionHolders.size() + " annotated @FileExportExecutor Components { " +
...
//                    log.warn("No Spring Bean annotating @FileExportExecutor was found in Spring BeanFactory");
//                }
//
//            }
//
...
//
//        FileExportExecutor service = findAnnotation(beanClass, FileExportExecutor.class);
//
//        Class<?> interfaceClass = checkExecutorInterfaceClass(beanClass, service);
//
...
//    }
//
//    private Class<?> checkExecutorInterfaceClass(Class<?> annotatedServiceBeanClass) {
//        Class<?>[] allInterfaces = annotatedServiceBeanClass.getInterfaces();
//        boolean existExecutor = false;
//        for (Class<?> aClass : allInterfaces) {
//            if (aClass.isAssignableFrom(BaseDownloadExecutor.class)){
//                existExecutor = true;
//                break;
//            }
//        }
//
//        Assert.isTrue(existExecutor,
//            "@FileExportExecutor interfaceClass() or interfaceName() or interface class must implement BaseDownloadExecutor!");
//
//        return BaseDownloadExecutor.class;
//    }
//
...
//    }
//
//    private AbstractBeanDefinition buildServiceBeanDefinition(FileExportExecutor service, Class<?> interfaceClass,

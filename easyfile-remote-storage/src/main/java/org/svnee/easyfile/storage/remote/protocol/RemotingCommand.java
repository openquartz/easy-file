...
public class RemotingCommand {
    ...
    public static final String SERIALIZE_TYPE_PROPERTY = "seq-gen.serialize.type";
    public static final String SERIALIZE_TYPE_ENV = "SEQ_GEN_SERIALIZE_TYPE";
    public static final String REMOTING_VERSION_KEY = "seq-gen.remoting.version";
    ...
    private byte[] headerEncode() {
        ...
        if (SerializeType.JSON == serializeTypeCurrentRPC) {
            ...
            throw new UnsupportedOperationException("not support serialize");
        }
    }

...
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_CLIENT_AUTHSERVER;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_CLIENT_CERTPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_CLIENT_KEYPASSWORD;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_CLIENT_KEYPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_CLIENT_TRUSTCERTPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_AUTHCLIENT;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_CERTPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_KEYPASSWORD;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_KEYPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_NEED_CLIENT_AUTH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_SERVER_TRUSTCERTPATH;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.TLS_TEST_MODE_ENABLE;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsClientAuthServer;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsClientCertPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsClientKeyPassword;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsClientKeyPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsClientTrustCertPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerAuthClient;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerCertPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerKeyPassword;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerKeyPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerNeedClientAuth;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsServerTrustCertPath;
import static org.svnee.easyfile.storage.remote.netty.TlsSystemConfig.tlsTestModeEnable;
...
public class TlsHelper {
        ...
        if (forClient) {
            if (tlsTestModeEnable) {
                ...
                return sslContextBuilder.keyManager(
                    ...
                    !isNullOrEmpty(tlsClientKeyPath) ? decryptionStrategy.decryptPrivateKey(tlsClientKeyPath, true)
                        : null,
            ...
            if (tlsTestModeEnable) {
                ...
                SslContextBuilder sslContextBuilder = SslContextBuilder.forServer(
                    ...
                    !isNullOrEmpty(tlsServerKeyPath) ? decryptionStrategy.decryptPrivateKey(tlsServerKeyPath, false)
                        : null,
    ...
    private static void extractTlsConfigFromFile(final File configFile) {
        ...
        tlsTestModeEnable = Boolean
            .parseBoolean(properties.getProperty(TLS_TEST_MODE_ENABLE, String.valueOf(tlsTestModeEnable)));
        ...
        tlsServerAuthClient = Boolean
            .parseBoolean(properties.getProperty(TLS_SERVER_AUTHCLIENT, String.valueOf(tlsServerAuthClient)));
        ...
        tlsClientAuthServer = Boolean
            .parseBoolean(properties.getProperty(TLS_CLIENT_AUTHSERVER, String.valueOf(tlsClientAuthServer)));

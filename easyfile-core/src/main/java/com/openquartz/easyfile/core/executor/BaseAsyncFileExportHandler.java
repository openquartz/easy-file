 ...
 * 异步文件处理器
 * 用于文件异步处理
 * 你可以直接继承 {@link DefaultAsyncFileExportHandler},
 *
 * @author svnee
 */
public interface BaseAsyncFileExportHandler extends FileHandlerExecutor<BaseExportExecutor, BaseExportRequestContext> {

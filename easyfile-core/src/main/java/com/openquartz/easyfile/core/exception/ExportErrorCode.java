 ...
 **/
@Getter
public enum ExportErrorCode implements EasyFileErrorCode {
    ...
    BASE_DOWNLOAD_EXECUTOR_IMPL_ILL_ERROR("06",
        "class:{0} must implement " + BaseExportExecutor.class, true),
    ...
    ExportErrorCode(String errorCode, String errorMsg) {
        this(errorCode, errorMsg, false);
    }

    ExportErrorCode(String errorCode, String errorMsg, boolean replacePlaceHold) {
